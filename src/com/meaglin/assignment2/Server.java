...
public class Server {
    ...
    /**
     * The main class setups a server and then runs the first half of
     * the nodes on this machine by starting nodes 1 to nodeCount/2 in
     * separate threads.
     * @param args                      ?
    ...
    public static void main(String[] args) throws RemoteException, InterruptedException {
        ...
        Thread.sleep(15000);                    // Wait some time for remote nodes.
        for(int i = 0; i < (nodeCount/2); i += 1) {
